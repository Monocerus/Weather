...
public class CircleRefreshLayout extends FrameLayout {
    ...
    private void setAttrs(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, com.weather.tianle.R.styleable.CirCleRefreshLayout);

        mHeaderBackColor = a.getColor(com.weather.tianle.R.styleable.CirCleRefreshLayout_AniBackColor, mHeaderBackColor);
        mHeaderForeColor = a.getColor(com.weather.tianle.R.styleable.CirCleRefreshLayout_AniForeColor, mHeaderForeColor);
        mHeaderCircleSmaller = a.getInt(com.weather.tianle.R.styleable.CirCleRefreshLayout_CircleSmaller, mHeaderCircleSmaller);
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (dy > 0 && Math.abs(dx)< 5 && !canChildScrollUp()) {
                    return true;
                }
        }
